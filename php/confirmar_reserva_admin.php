...
try {
    ...
    $asunto = "Reserva confirmada - Hotel Restaurante Rio Piedra";
    ...
    $mensaje = "
        ...
        <p>Te informamos de que tu reserva ha sido <strong>confirmada</strong>.</p>

        {$detalleReserva}

        <p><strong>Estado actual:</strong> Confirmada</p>
